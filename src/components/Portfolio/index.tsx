		...
		<div className='portfolioContent'>
			...
			<div className='projects'>
				<Projects
					...
					projectInfo='ServiceDash allows users to sign up, submit service request applications, and admins are able to assign those applications to companies that meet the needs of the users request.'
					githubRepo='https://github.com/Gray754/personal_project'
				/>
				<Projects
					projectImg={WellTreadImg}
					projectName='Well Tread'
					projectInfo='Well Tread is a web app that lets users look for and track hiking, mountain biking, and running trails across the US.'
